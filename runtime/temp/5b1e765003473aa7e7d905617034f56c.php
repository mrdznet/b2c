<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\System\addShopAdv.html";i:1522669855;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<dd>
			<p>
				<select name="" id="ap_id" class="select-common">
					...
					<?php if(!(empty($platform_adv_position_list) || (($platform_adv_position_list instanceof \think\Collection || $platform_adv_position_list instanceof \think\Paginator ) && $platform_adv_position_list->isEmpty()))): if(is_array($platform_adv_position_list) || $platform_adv_position_list instanceof \think\Collection || $platform_adv_position_list instanceof \think\Paginator): if( count($platform_adv_position_list)==0 ) : echo "" ;else: foreach($platform_adv_position_list as $key=>$vo): ?>
						<option value="<?php echo $vo['ap_id']; ?>" ap-class="<?php echo $vo['ap_class']; ?>"><?php echo $vo['ap_name']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; endif; ?>
				</select>
			</p>
