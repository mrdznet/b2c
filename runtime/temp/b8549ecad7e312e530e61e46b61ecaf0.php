<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:45:"template/adminblue\Promotion\addGroupBuy.html";i:1522478804;s:28:"template/adminblue\base.html";i:1522831681;s:45:"template/adminblue\controlCommonVariable.html";i:1522486340;s:32:"template/adminblue\urlModel.html";i:1510819828;s:51:"template/adminblue\Promotion\goodsSelectDialog.html";i:1521778980;s:34:"template/adminblue\pageCommon.html";i:1512444925;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
						...
						html += '<tr>';
							...
							if(action == "discount"){
								...
								if(selected_data != undefined){
									...
									html += '<td><input type="number" name="discount" class="input-common short" onchange="discount(this);" goodsid="'+ data["data"][i]["goods_id"] +'" value="'+ discount +'">&nbsp;折</td>';
								}else{
									html += '<td><input type="number" name="discount" class="input-common short" onchange="discount(this);" goodsid="'+ data["data"][i]["goods_id"] +'" value="9.99">&nbsp;折</td>';
								}
							}else{
								html += '<td></td>';
							}
