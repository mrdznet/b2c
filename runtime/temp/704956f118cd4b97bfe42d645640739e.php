...
<section class="g-flexview">
    <header class="m-navbar">
        ...
        <div class="navbar-center"><span class="navbar-title">限时折扣</span></div>
    ...
    <section class="g-scrollview" id="J_List">
        <div class="m-slider" data-ydui-slider="{autoplay: 3000}">
            <div class="slider-wrapper">
                <?php $tag_md5 = json_encode(["getPlatformAdvPositionDetail","1163","*"]);if(cache("TAG_".md5($tag_md5))):$adv = cache("TAG_".md5($tag_md5));else:$service = new data\service\Platform;$adv = $service->getPlatformAdvPositionDetail("1163", "*");$adv = json_encode($adv);$adv = json_decode($adv, ture);cache("TAG_".md5($tag_md5), $adv, 3600);endif; if(is_array($adv['adv_list']) || $adv['adv_list'] instanceof \think\Collection || $adv['adv_list'] instanceof \think\Paginator): if( count($adv['adv_list'])==0 ) : echo "" ;else: foreach($adv['adv_list'] as $key=>$vo): ?>
...
<script type="text/javascript" src="__TEMP__/<?php echo $style; ?>/public/js/discount.js"></script>
