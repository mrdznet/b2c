...
-- Script date 2018/4/13 18:58:30
...
-- Table niushop_b2c_data21.nc_cms_article does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_article_class
--

-- Table niushop_b2c_data21.nc_cms_article_class does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_comment
--

-- Table niushop_b2c_data21.nc_cms_comment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_topic
--

-- Table niushop_b2c_data21.nc_cms_topic does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account
--

-- Table niushop_b2c_data21.ns_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_assistant_records
--

-- Table niushop_b2c_data21.ns_account_assistant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_order_records
--

-- Table niushop_b2c_data21.ns_account_order_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_period
--

-- Table niushop_b2c_data21.ns_account_period does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_records
--

-- Table niushop_b2c_data21.ns_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_return_records
--

-- Table niushop_b2c_data21.ns_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_records
--

-- Table niushop_b2c_data21.ns_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_user_records
--

-- Table niushop_b2c_data21.ns_account_withdraw_user_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_attribute
--

-- Table niushop_b2c_data21.ns_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_attribute_value
--

-- Table niushop_b2c_data21.ns_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_cart
--

-- Table niushop_b2c_data21.ns_cart does not contain any data (it is empty)

-- 
-- Dumping data for table ns_click_fabulous
--

-- Table niushop_b2c_data21.ns_click_fabulous does not contain any data (it is empty)

-- 
-- Dumping data for table ns_combo_package_promotion
--

-- Table niushop_b2c_data21.ns_combo_package_promotion does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult
--

-- Table niushop_b2c_data21.ns_consult does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult_type
--

-- Table niushop_b2c_data21.ns_consult_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon
--

-- Table niushop_b2c_data21.ns_coupon does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_goods
--

-- Table niushop_b2c_data21.ns_coupon_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_type
--

-- Table niushop_b2c_data21.ns_coupon_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_customer_service
--

-- Table niushop_b2c_data21.ns_customer_service does not contain any data (it is empty)

-- 
-- Dumping data for table ns_customer_service_records
--

-- Table niushop_b2c_data21.ns_customer_service_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_company
--

-- Table niushop_b2c_data21.ns_express_company does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping
--

-- Table niushop_b2c_data21.ns_express_shipping does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping_items
--

-- Table niushop_b2c_data21.ns_express_shipping_items does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_gift_grant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods
--

-- Table niushop_b2c_data21.ns_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute
--

-- Table niushop_b2c_data21.ns_goods_attribute does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_deleted
--

-- Table niushop_b2c_data21.ns_goods_attribute_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_value
--

-- Table niushop_b2c_data21.ns_goods_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_brand
--

-- Table niushop_b2c_data21.ns_goods_brand does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_browse
--

-- Table niushop_b2c_data21.ns_goods_browse does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category
--

-- Table niushop_b2c_data21.ns_goods_category does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_category_block
--

-- Table niushop_b2c_data21.ns_goods_category_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_comment
--

-- Table niushop_b2c_data21.ns_goods_comment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_deleted
--

-- Table niushop_b2c_data21.ns_goods_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_evaluate
--

-- Table niushop_b2c_data21.ns_goods_evaluate does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_group
--

-- Table niushop_b2c_data21.ns_goods_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_ladder_preferential
--

-- Table niushop_b2c_data21.ns_goods_ladder_preferential does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku
--

-- Table niushop_b2c_data21.ns_goods_sku does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_deleted
--

-- Table niushop_b2c_data21.ns_goods_sku_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture
--

-- Table niushop_b2c_data21.ns_goods_sku_picture does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture_delete
--

-- Table niushop_b2c_data21.ns_goods_sku_picture_delete does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec
--

-- Table niushop_b2c_data21.ns_goods_spec does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_spec_value
--

-- Table niushop_b2c_data21.ns_goods_spec_value does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_member_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account_records
--

-- Table niushop_b2c_data21.ns_member_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_balance_withdraw
--

-- Table niushop_b2c_data21.ns_member_balance_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_bank_account
--

-- Table niushop_b2c_data21.ns_member_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_express_address
--

-- Table niushop_b2c_data21.ns_member_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_favorites
--

-- Table niushop_b2c_data21.ns_member_favorites does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_gift
--

-- Table niushop_b2c_data21.ns_member_gift does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_member_recharge does not contain any data (it is empty)

-- 
-- Dumping data for table ns_notice
--

-- Table niushop_b2c_data21.ns_notice does not contain any data (it is empty)

-- 
-- Dumping data for table ns_o2o_distribution_area
--

-- Table niushop_b2c_data21.ns_o2o_distribution_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_o2o_distribution_config
--

-- Table niushop_b2c_data21.ns_o2o_distribution_config does not contain any data (it is empty)

-- 
-- Dumping data for table ns_o2o_distribution_user
--

-- Table niushop_b2c_data21.ns_o2o_distribution_user does not contain any data (it is empty)

-- 
-- Dumping data for table ns_o2o_order_delivery
--

-- Table niushop_b2c_data21.ns_o2o_order_delivery does not contain any data (it is empty)

-- 
-- Dumping data for table ns_offpay_area
--

-- Table niushop_b2c_data21.ns_offpay_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order
--

-- Table niushop_b2c_data21.ns_order does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_action
--

-- Table niushop_b2c_data21.ns_order_action does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_customer_account_records
--

-- Table niushop_b2c_data21.ns_order_customer_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods
--

-- Table niushop_b2c_data21.ns_order_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_express
--

-- Table niushop_b2c_data21.ns_order_goods_express does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_promotion_details
--

-- Table niushop_b2c_data21.ns_order_goods_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_payment
--

-- Table niushop_b2c_data21.ns_order_payment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_pickup
--

-- Table niushop_b2c_data21.ns_order_pickup does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_presell
--

-- Table niushop_b2c_data21.ns_order_presell does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_promotion_details
--

-- Table niushop_b2c_data21.ns_order_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund
--

-- Table niushop_b2c_data21.ns_order_refund does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund_account_records
--

-- Table niushop_b2c_data21.ns_order_refund_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shipping_fee
--

-- Table niushop_b2c_data21.ns_order_shipping_fee does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shop_return
--

-- Table niushop_b2c_data21.ns_order_shop_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_pickup_point
--

-- Table niushop_b2c_data21.ns_pickup_point does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_adv
--

-- Table niushop_b2c_data21.ns_platform_adv does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_platform_block does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend
--

-- Table niushop_b2c_data21.ns_platform_goods_recommend does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend_class
--

-- Table niushop_b2c_data21.ns_platform_goods_recommend_class does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_platform_link does not contain any data (it is empty)

-- 
-- Dumping data for table ns_point_config
--

-- Table niushop_b2c_data21.ns_point_config does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling
--

-- Table niushop_b2c_data21.ns_promotion_bundling does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling_goods
--

-- Table niushop_b2c_data21.ns_promotion_bundling_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount
--

-- Table niushop_b2c_data21.ns_promotion_discount does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount_goods
--

-- Table niushop_b2c_data21.ns_promotion_discount_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_full_mail
--

-- Table niushop_b2c_data21.ns_promotion_full_mail does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_game_rule
--

-- Table niushop_b2c_data21.ns_promotion_game_rule does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_promotion_games does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_games_winning_records
--

-- Table niushop_b2c_data21.ns_promotion_games_winning_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift
--

-- Table niushop_b2c_data21.ns_promotion_gift does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_goods
--

-- Table niushop_b2c_data21.ns_promotion_gift_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_grant_records
--

-- Table niushop_b2c_data21.ns_promotion_gift_grant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_group_buy
--

-- Table niushop_b2c_data21.ns_promotion_group_buy does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_group_buy_ladder
--

-- Table niushop_b2c_data21.ns_promotion_group_buy_ladder does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong
--

-- Table niushop_b2c_data21.ns_promotion_mansong does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_goods
--

-- Table niushop_b2c_data21.ns_promotion_mansong_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_rule
--

-- Table niushop_b2c_data21.ns_promotion_mansong_rule does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_topic
--

-- Table niushop_b2c_data21.ns_promotion_topic does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_topic_goods
--

-- Table niushop_b2c_data21.ns_promotion_topic_goods does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_shop does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_ad
--

-- Table niushop_b2c_data21.ns_shop_ad does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_coin_records
--

-- Table niushop_b2c_data21.ns_shop_coin_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_express_address
--

-- Table niushop_b2c_data21.ns_shop_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_group
--

-- Table niushop_b2c_data21.ns_shop_group does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_shop_order_account_records does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_supplier does not contain any data (it is empty)

-- 
-- Dumping data for table ns_verification_person
--

-- Table niushop_b2c_data21.ns_verification_person does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods
--

-- Table niushop_b2c_data21.ns_virtual_goods does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.ns_virtual_goods_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_virtual_goods_verification
--

-- Table niushop_b2c_data21.ns_virtual_goods_verification does not contain any data (it is empty)

-- 
-- Dumping data for table sys_addons
--

-- Table niushop_b2c_data21.sys_addons does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.sys_album_picture does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.sys_custom_template does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.sys_instance_type does not contain any data (it is empty)
...
(10092, '组合套餐', 'admin', 'promotion', 'combopackagepromotionlist', 179, 2, 'promotion/combopackagepromotionlist', 1, 0, 6, '相关教程：<a href="http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2319&extra=page%3D2" target="_blank">http://bbs.niushop.com.cn/forum.php?mod=viewthread&tid=2319&extra=page%3D2</a>', '', '', 1, 1513941932, 0),
...
(10107, '互动游戏', 'admin', 'Promotion', 'promotionGamesList', 179, 2, 'Promotion/promotionGamesList', 1, 0, 10, '互动游戏', '', '', 1, 1517565421, 0),
...
(10114, '团购', 'admin', 'Promotion', 'groupBuyList', 179, 2, 'Promotion/groupBuyList', 1, 0, 10, '团购', '', '', 1, 1522756903, 0),
...
(10117, '微信小程序管理', 'admin', 'wchat', 'appletConfig', 335, 2, 'wchat/appletConfig', 1, 0, 1, '微信小程序管理', '', '', 1, 1522756903, 0),
...
(10131, '预售订单', 'admin', 'orderpresell', 'orderPresellList', 184, 2, 'orderpresell/orderPresellList', 1, 0, 3, '预售订单', '', '', 1, 1522756924, 0),
(10132, '专题活动', 'admin', 'promotion', 'topiclist', 179, 2, 'promotion/topiclist', 1, 0, 12, '', '', '', 1, 1522756924, 0),
...
(10136, '核销设置', 'admin', 'Verification', 'index', 218, 2, 'Verification/index', 1, 0, 8, '', '', '', 1, 1522756927, 0),
...
-- Table niushop_b2c_data21.sys_notice_records does not contain any data (it is empty)

-- 
-- Dumping data for table sys_notice_template
--

-- Table niushop_b2c_data21.sys_notice_template does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.sys_shortcut_menu does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.sys_user_log does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_devolution
--

-- Table niushop_b2c_data21.sys_version_devolution does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_patch
--

-- Table niushop_b2c_data21.sys_version_patch does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_update_records
--

-- Table niushop_b2c_data21.sys_version_update_records does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wap_custom_template
--

-- Table niushop_b2c_data21.sys_wap_custom_template does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.sys_weixin_auth does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_default_replay
--

-- Table niushop_b2c_data21.sys_weixin_default_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_fans
--

-- Table niushop_b2c_data21.sys_weixin_fans does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_follow_replay
--

-- Table niushop_b2c_data21.sys_weixin_follow_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_functions_button
--

-- Table niushop_b2c_data21.sys_weixin_functions_button does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_instance_msg
--

-- Table niushop_b2c_data21.sys_weixin_instance_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_key_replay
--

-- Table niushop_b2c_data21.sys_weixin_key_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media
--

-- Table niushop_b2c_data21.sys_weixin_media does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media_item
--

-- Table niushop_b2c_data21.sys_weixin_media_item does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_menu
--

-- Table niushop_b2c_data21.sys_weixin_menu does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_msg_template
--

-- Table niushop_b2c_data21.sys_weixin_msg_template does not contain any data (it is empty)
...
-- Table niushop_b2c_data21.sys_weixin_user_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_user_msg_replay
--

-- Table niushop_b2c_data21.sys_weixin_user_msg_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wexin_onekeysubscribe
--

-- Table niushop_b2c_data21.sys_wexin_onekeysubscribe does not contain any data (it is empty)
