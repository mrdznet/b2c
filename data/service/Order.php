...
class Order extends BaseService implements IOrder
{
     ...
     * 预售订单创建(暂不支持货到付款)
     */
    public function orderCreatePresell($order_type, $out_trade_no, $pay_type, $shipping_type, $order_from, $buyer_ip, $buyer_message, $buyer_invoice, $shipping_time, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $point, $coupon_id, $user_money, $goods_sku_list, $platform_money, $pick_up_id, $shipping_company_id, $coin = 0, $fixed_telephone = "", $is_full_payment){
        
        $order = new OrderBusiness();
        $retval = $order->orderCreatePresell($order_type, $out_trade_no, $pay_type, $shipping_type, $order_from, $buyer_ip, $buyer_message, $buyer_invoice, $shipping_time, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $point, $coupon_id, $user_money, $goods_sku_list, $platform_money, $pick_up_id, $shipping_company_id, $coin, $fixed_telephone, $is_full_payment);
        runhook("Notify", "orderCreate", array(
            "order_id" => $retval
        ));
        // 针对特殊订单执行支付处理
        if ($retval > 0) {
            ...
            $order_info = $presell_order_model->getInfo(['presell_order_id'=>$retval], '*');
    ...
    public function getPresellOrderNewOutTradeNo($presell_order_id)
    {
        ...
        $out_trade_no = $presell_order_model->getInfo(['presell_order_id' => $presell_order_id], 'out_trade_no');
