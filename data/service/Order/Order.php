...
class Order extends BaseService
{
     ...
     * @param string $fixed_telephone            
     */
    public function orderCreatePresell($order_type, $out_trade_no, $pay_type, $shipping_type, $order_from, $buyer_ip, $buyer_message, $buyer_invoice, $shipping_time, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $point, $coupon_id, $user_money, $goods_sku_list, $platform_money, $pick_up_id, $shipping_company_id, $coin, $fixed_telephone = "", $is_full_payment = 0)
    {
        ...
        try {
            ...
            // 创建订单，类型为预售订单
            $order_id = $this->orderCreate($order_type, $order_out_trade_no, $pay_type, $shipping_type, $order_from, $buyer_ip, $buyer_message, $buyer_invoice, $shipping_time, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, 0, $coupon_id, $user_money, $goods_sku_list, 0.00, $pick_up_id, $shipping_company_id, $coin, $fixed_telephone, $presell_money);
            if ($order_id < 0) {
            ...
            $pay = new UnifyPay();
            $pay->createPayment($shop_id, $out_trade_no, $shop_name . "预售金订单", $shop_name . "预售金订单", $presell_pay, 5, $presell_order_id);
    ...
    public function presellOrderPay($order_pay_no, $pay_type, $status = 1)
    {
        ...
        try {
            ...
            $res = $presell_order_model->save($data, [
                'out_trade_no' => $order_pay_no
            ]);
