...
class PresellOrder extends Order
{
    ...
    public function pintuanOrderCreate()
    {
        ...
        if (! empty($purchase_restriction)) {
            ...
            $order_id = $pintuan->pintuanOrderCreate(4, $out_trade_no, $pay_type, $shipping_type, $order_from, 1, $buyer_message, $buyer_invoice, $shipping_time, $receiver_mobile, $receiver_province, $receiver_city, $receiver_district, $receiver_address, $receiver_zip, $receiver_name, $point, 0, $goods_sku_list, $user_money, $pick_up_id, $shipping_company_id, $coin, $tuangou_group_id);
            $_SESSION['unpaid_goback'] = __URL(__URL__ . "/wap/PresellOrder/orderdetail?orderId=" . $order_id);
            if ($order_id > 0) {
